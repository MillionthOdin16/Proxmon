...
.method public constructor <init>(Landroid/view/View;Lio/flutter/embedding/engine/j/b;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/j;)V
    ...
    iput-object v1, p0, Lio/flutter/view/c;->x:Landroid/database/ContentObserver;
    ...
    iget-object p1, p0, Lio/flutter/view/c;->v:Landroid/view/accessibility/AccessibilityManager$AccessibilityStateChangeListener;
    ...
    iget-object p1, p0, Lio/flutter/view/c;->c:Landroid/view/accessibility/AccessibilityManager;

    iget-object p2, p0, Lio/flutter/view/c;->v:Landroid/view/accessibility/AccessibilityManager$AccessibilityStateChangeListener;
    ...
    iput-object p1, p0, Lio/flutter/view/c;->w:Landroid/view/accessibility/AccessibilityManager$TouchExplorationStateChangeListener;
    ...
    iget-object p2, p0, Lio/flutter/view/c;->w:Landroid/view/accessibility/AccessibilityManager$TouchExplorationStateChangeListener;
    ...
    iget-object p1, p0, Lio/flutter/view/c;->x:Landroid/database/ContentObserver;
    ...
    iget-object p2, p0, Lio/flutter/view/c;->f:Landroid/content/ContentResolver;

    iget-object p3, p0, Lio/flutter/view/c;->x:Landroid/database/ContentObserver;
    ...
    invoke-interface {p6, p0}, Lio/flutter/plugin/platform/j;->a(Lio/flutter/view/c;)V
...
.method private H(Lio/flutter/view/c$l;ILandroid/os/Bundle;Z)Z
    ...
    sget-object p4, Lio/flutter/view/c$g;->w:Lio/flutter/view/c$g;
    ...
    sget-object p4, Lio/flutter/view/c$g;->m:Lio/flutter/view/c$g;
...
.method private I(Lio/flutter/view/c$l;ILandroid/os/Bundle;)Z
    ...
    sget-object v1, Lio/flutter/view/c$g;->x:Lio/flutter/view/c$g;
...
.method private R(Lio/flutter/view/c$l;)Z
    ...
    invoke-static {v0, v1}, Lio/flutter/view/c$l;->d(Lio/flutter/view/c$l;Ld/a/d/c;)Z
    ...
    invoke-static {p1, v0}, Lio/flutter/view/c$l;->d(Lio/flutter/view/c$l;Ld/a/d/c;)Z
...
.method private U(Lio/flutter/view/c$l;)V
    ...
    invoke-interface {v4, v5}, Lio/flutter/plugin/platform/j;->c(Ljava/lang/Integer;)Landroid/view/View;
    ...
    invoke-interface {v1, v3}, Lio/flutter/plugin/platform/j;->d(Ljava/lang/Integer;)Z
    ...
    invoke-interface {v1, v3}, Lio/flutter/plugin/platform/j;->c(Ljava/lang/Integer;)Landroid/view/View;
...
.method private r()Z
    ...
    invoke-static {v0}, Ld/a/d/d;->b(Landroid/content/Context;)Landroid/app/Activity;
...
.method public E(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, p1}, Ld/a/b;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method T(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V
    ...
    invoke-interface {v3, v4}, Lio/flutter/plugin/platform/j;->d(Ljava/lang/Integer;)Z
    ...
    invoke-interface {v3, v1}, Lio/flutter/plugin/platform/j;->c(Ljava/lang/Integer;)Landroid/view/View;
    ...
    sget-object v6, Lio/flutter/view/c$i;->p:Lio/flutter/view/c$i;
...
.method public createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-interface {v5, v6}, Lio/flutter/plugin/platform/j;->d(Ljava/lang/Integer;)Z
    ...
    iget-object v5, p0, Lio/flutter/view/c;->m:Lio/flutter/view/c$l;
    ...
    :cond_7
    iget-object v5, p0, Lio/flutter/view/c;->i:Lio/flutter/view/c$l;
    ...
    :cond_9
    sget-object v5, Lio/flutter/view/c$i;->g:Lio/flutter/view/c$i;

    invoke-static {v3, v5}, Lio/flutter/view/c$l;->h(Lio/flutter/view/c$l;Lio/flutter/view/c$i;)Z
    ...
    sget-object v5, Lio/flutter/view/c$i;->m:Lio/flutter/view/c$i;
    ...
    sget-object v5, Lio/flutter/view/c$i;->v:Lio/flutter/view/c$i;
    ...
    :cond_c
    sget-object v5, Lio/flutter/view/c$g;->l:Lio/flutter/view/c$g;

    invoke-static {v3, v5}, Lio/flutter/view/c$l;->m(Lio/flutter/view/c$l;Lio/flutter/view/c$g;)Z
    ...
    :goto_2
    sget-object v10, Lio/flutter/view/c$g;->m:Lio/flutter/view/c$g;

    invoke-static {v3, v10}, Lio/flutter/view/c$l;->m(Lio/flutter/view/c$l;Lio/flutter/view/c$g;)Z
    ...
    :cond_e
    sget-object v10, Lio/flutter/view/c$g;->v:Lio/flutter/view/c$g;
    ...
    invoke-static {v9}, Lio/flutter/view/c$h;->a(Lio/flutter/view/c$h;)Ljava/lang/String;
    ...
    sget-object v5, Lio/flutter/view/c$i;->s:Lio/flutter/view/c$i;
    ...
    invoke-interface {v2, v3}, Lio/flutter/plugin/platform/j;->c(Ljava/lang/Integer;)Landroid/view/View;
    ...
    invoke-interface {v3, v5}, Lio/flutter/plugin/platform/j;->d(Ljava/lang/Integer;)Z
...
.method public performAction(IILandroid/os/Bundle;)Z
    ...
    :cond_3
    invoke-direct {p0, v2, p1, p3}, Lio/flutter/view/c;->I(Lio/flutter/view/c$l;ILandroid/os/Bundle;)Z
    ...
    invoke-static {v2, p2}, Lio/flutter/view/c$l;->m(Lio/flutter/view/c$l;Lio/flutter/view/c$g;)Z
    ...
    invoke-static {v2, p2}, Lio/flutter/view/c$l;->p(Lio/flutter/view/c$l;Ljava/lang/String;)Ljava/lang/String;

    invoke-static {v2}, Lio/flutter/view/c$l;->D(Lio/flutter/view/c$l;)Ljava/util/List;

    move-result-object p2

    invoke-static {v2, p2}, Lio/flutter/view/c$l;->A(Lio/flutter/view/c$l;Ljava/util/List;)Ljava/util/List;

    invoke-direct {p0, p1, v4}, Lio/flutter/view/c;->L(II)V
    ...
    invoke-static {v2}, Lio/flutter/view/c$l;->z(Lio/flutter/view/c$l;)Ljava/lang/String;

    move-result-object p2

    invoke-static {v2, p2}, Lio/flutter/view/c$l;->p(Lio/flutter/view/c$l;Ljava/lang/String;)Ljava/lang/String;

    invoke-static {v2}, Lio/flutter/view/c$l;->B(Lio/flutter/view/c$l;)Ljava/util/List;
    ...
    sget-object p3, Lio/flutter/view/c$g;->i:Lio/flutter/view/c$g;
    ...
    :cond_d
    invoke-direct {p0, v2, p1, p3, v3}, Lio/flutter/view/c;->H(Lio/flutter/view/c$l;ILandroid/os/Bundle;Z)Z
    ...
    :cond_e
    invoke-direct {p0, v2, p1, p3, v6}, Lio/flutter/view/c;->H(Lio/flutter/view/c$l;ILandroid/os/Bundle;Z)Z
    ...
    invoke-direct {p0, p1, v0}, Lio/flutter/view/c;->L(II)V
