...
.field private localizationPlugin:Ld/a/c/b/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Ld/a/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/f/c;->b(ILjava/nio/ByteBuffer;)V
...
.method computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Ld/a/c/b/a;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Ld/a/c/b/a;

    invoke-virtual {p1, v0}, Ld/a/c/b/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$g;Ljava/lang/Object;)V
    ...
    sget-object v0, Ld/a/c/a/p;->a:Ld/a/c/a/p;

    invoke-virtual {v0, p3}, Ld/a/c/a/p;->b(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/c$g;->b:I
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/f/c;->d(Ljava/lang/String;Ljava/nio/ByteBuffer;I)V
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/k;->P()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/k;->R(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/k;->S(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/k;->T()V
...
.method public requestDartDeferredLibrary(I)V
    ...
    invoke-static {p1, v0}, Ld/a/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setLocalizationPlugin(Ld/a/c/b/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Ld/a/c/b/a;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, v0}, Ld/a/d/b;->a(ZLjava/lang/Object;)V
