...
.field private f:Lio/flutter/embedding/android/h$b;
...
.method constructor <init>(Landroid/content/Context;Landroid/media/ImageReader;Lio/flutter/embedding/android/h$b;)V
    ...
    iput-object p2, p0, Lio/flutter/embedding/android/h;->b:Landroid/media/ImageReader;

    iput-object p3, p0, Lio/flutter/embedding/android/h;->f:Lio/flutter/embedding/android/h$b;
...
.method private e()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/h;->c:Landroid/media/Image;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/h;->c:Landroid/media/Image;
...
.method private i()V
    ...
    iput-object v1, p0, Lio/flutter/embedding/android/h;->d:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/h;->c:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->getHeight()I

    move-result v2

    iget-object v3, p0, Lio/flutter/embedding/android/h;->d:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->d:Landroid/graphics/Bitmap;
...
.method public a(Lio/flutter/embedding/engine/renderer/a;)V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/h;->f:Lio/flutter/embedding/android/h$b;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/h;->b:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/h;->e:Lio/flutter/embedding/engine/renderer/a;
...
.method public c()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/h;->d:Landroid/graphics/Bitmap;
...
.method public getAttachedRenderer()Lio/flutter/embedding/engine/renderer/a;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/h;->e:Lio/flutter/embedding/engine/renderer/a;
...
.method public h(II)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/h;->b:Landroid/media/ImageReader;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/h;->d:Landroid/graphics/Bitmap;
...
.method protected onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lio/flutter/embedding/android/h;->b:Landroid/media/ImageReader;
    ...
    :cond_0
    iget-object p3, p0, Lio/flutter/embedding/android/h;->f:Lio/flutter/embedding/android/h$b;

    sget-object p4, Lio/flutter/embedding/android/h$b;->b:Lio/flutter/embedding/android/h$b;

    if-ne p3, p4, :cond_1

    iget-boolean p3, p0, Lio/flutter/embedding/android/h;->g:Z

    if-eqz p3, :cond_1

    invoke-virtual {p0, p1, p2}, Lio/flutter/embedding/android/h;->h(II)V

    iget-object p1, p0, Lio/flutter/embedding/android/h;->e:Lio/flutter/embedding/engine/renderer/a;

    iget-object p2, p0, Lio/flutter/embedding/android/h;->b:Landroid/media/ImageReader;
