...
.method private f(Lio/flutter/embedding/android/k;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->i()Lio/flutter/embedding/android/o;

    move-result-object v0

    sget-object v1, Lio/flutter/embedding/android/o;->b:Lio/flutter/embedding/android/o;
...
.method private g()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->f()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->getActivity()Landroid/app/Activity;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->r()Ljava/lang/String;
...
.method B(I)V
    ...
    invoke-static {v1, p1}, Ld/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method C()V
    ...
    invoke-static {v1, v0}, Ld/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method E()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/f$c;->k()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/f$c;->d()Landroid/content/Context;

    move-result-object v3

    invoke-interface {v1, v3}, Lio/flutter/embedding/android/f$c;->s(Landroid/content/Context;)Lio/flutter/embedding/engine/b;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->g()Lio/flutter/embedding/engine/e;
    ...
    invoke-interface {v3}, Lio/flutter/embedding/android/f$c;->l()Z
...
.method public c()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->j()Z
...
.method m(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/i/c/b;->onActivityResult(IILandroid/content/Intent;)Z
...
.method n(Landroid/content/Context;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/f$c;->h()Z
    ...
    invoke-static {p1, v0}, Ld/a/b;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->getLifecycle()Landroidx/lifecycle/d;
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/f$c;->getActivity()Landroid/app/Activity;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/f;->b:Lio/flutter/embedding/engine/b;

    invoke-interface {p1, v0, v1}, Lio/flutter/embedding/android/f$c;->p(Landroid/app/Activity;Lio/flutter/embedding/engine/b;)Lio/flutter/plugin/platform/e;
    ...
    invoke-interface {p1, v0}, Lio/flutter/embedding/android/f$c;->w(Lio/flutter/embedding/engine/b;)V
...
.method p(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-static {p1, p2}, Ld/a/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0}, Lio/flutter/embedding/android/f;->h()V

    iget-object p2, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {p2}, Lio/flutter/embedding/android/f$c;->i()Lio/flutter/embedding/android/o;

    move-result-object p2

    sget-object p3, Lio/flutter/embedding/android/o;->b:Lio/flutter/embedding/android/o;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/f$c;->d()Landroid/content/Context;

    move-result-object p3

    iget-object v2, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->u()Lio/flutter/embedding/android/r;

    move-result-object v2

    sget-object v3, Lio/flutter/embedding/android/r;->c:Lio/flutter/embedding/android/r;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/f$c;->q(Lio/flutter/embedding/android/i;)V

    new-instance p3, Lio/flutter/embedding/android/k;

    iget-object v0, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->d()Landroid/content/Context;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/f$c;->u()Lio/flutter/embedding/android/r;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/f$c;->v(Lio/flutter/embedding/android/j;)V
    ...
    invoke-interface {p2}, Lio/flutter/embedding/android/f$c;->o()Lio/flutter/embedding/android/q;
    ...
    invoke-static {p1, p3}, Ld/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p3}, Ld/a/d/d;->a(I)I
...
.method r()V
    ...
    invoke-interface {v1, v2}, Lio/flutter/embedding/android/f$c;->n(Lio/flutter/embedding/engine/b;)V

    iget-object v1, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {v1}, Lio/flutter/embedding/android/f$c;->h()Z
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->k()Ljava/lang/String;
...
.method s(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/embedding/engine/i/c/b;->a(Landroid/content/Intent;)V
...
.method w(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->h()Z
