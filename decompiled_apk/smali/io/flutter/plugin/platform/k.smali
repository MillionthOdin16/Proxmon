...
.field private e:Lio/flutter/view/f;
...
.method private N(Lio/flutter/plugin/platform/l;)V
    .locals 1
...
.method private static V(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
    .locals 3
...
.method private static W(Ljava/lang/Object;F)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, p1}, Lio/flutter/plugin/platform/k;->V(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
...
.method private static X(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
    .locals 2
...
.method private static Y(Ljava/lang/Object;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/k;->X(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
...
.method private b0(Lio/flutter/plugin/platform/l;)V
    .locals 1
...
.method private d0(II)V
    ...
    invoke-static {p2, p1}, Ld/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic e(I)Z
    ...
    invoke-static {p0}, Lio/flutter/plugin/platform/k;->c0(I)Z
...
.method static synthetic i(Lio/flutter/plugin/platform/k;Lio/flutter/plugin/platform/l;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/k;->N(Lio/flutter/plugin/platform/l;)V
...
.method static synthetic j(Lio/flutter/plugin/platform/k;Lio/flutter/plugin/platform/l;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/k;->b0(Lio/flutter/plugin/platform/l;)V
...
.method static synthetic p(Lio/flutter/plugin/platform/k;D)I
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/k;->a0(D)I
...
.method static synthetic q(Lio/flutter/plugin/platform/k;II)V
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/k;->d0(II)V

    return-void
.end method

.method static synthetic r(Lio/flutter/plugin/platform/k;)Lio/flutter/view/f;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/k;->e:Lio/flutter/view/f;
...
.method public C()V
    ...
    iput-object v1, p0, Lio/flutter/plugin/platform/k;->e:Lio/flutter/view/f;
...
.method public S(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    .locals 7
...
.method public Z(FLio/flutter/embedding/engine/j/j$d;Z)Landroid/view/MotionEvent;
    .locals 20
    ...
    invoke-static {v3}, Lio/flutter/plugin/platform/k;->Y(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v3, v4}, Lio/flutter/plugin/platform/k;->W(Ljava/lang/Object;F)Ljava/util/List;
...
.method public u(Landroid/content/Context;Lio/flutter/view/f;Lio/flutter/embedding/engine/f/a;)V
    .locals 1
    ...
    iput-object p2, p0, Lio/flutter/plugin/platform/k;->e:Lio/flutter/view/f;
