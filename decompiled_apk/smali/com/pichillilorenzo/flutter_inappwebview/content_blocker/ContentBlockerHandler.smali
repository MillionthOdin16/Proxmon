...
.method public checkUrl(Lcom/pichillilorenzo/flutter_inappwebview/in_app_webview/InAppWebView;Ljava/lang/String;Lcom/pichillilorenzo/flutter_inappwebview/content_blocker/ContentBlockerTriggerResourceType;)Landroid/webkit/WebResourceResponse;
    ...
    new-instance v5, Le/e0$a;

    invoke-direct {v5}, Le/e0$a;-><init>()V

    invoke-virtual {v5, v0}, Le/e0$a;->g(Ljava/lang/String;)Le/e0$a;

    invoke-virtual {v5}, Le/e0$a;->a()Le/e0;

    move-result-object v0

    :try_start_1
    invoke-static {}, Lcom/pichillilorenzo/flutter_inappwebview/Util;->getUnsafeOkHttpClient()Le/b0;

    move-result-object v5

    invoke-virtual {v5, v0}, Le/b0;->s(Le/e0;)Le/j;

    move-result-object v0

    invoke-interface {v0}, Le/j;->r()Le/g0;
    ...
    :try_start_2
    invoke-virtual {v5}, Le/g0;->r()Le/h0;

    move-result-object v0

    invoke-virtual {v0}, Le/h0;->A()[B
    ...
    invoke-virtual {v5, v0, v10}, Le/g0;->E(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v12}, Le/h0;->close()V

    invoke-virtual {v5}, Le/g0;->close()V
    ...
    invoke-virtual {v6}, Le/h0;->close()V
...
.method public getResourceTypeFromUrl(Ljava/lang/String;)Lcom/pichillilorenzo/flutter_inappwebview/content_blocker/ContentBlockerTriggerResourceType;
    ...
    :cond_0
    new-instance v3, Le/e0$a;

    invoke-direct {v3}, Le/e0$a;-><init>()V

    invoke-virtual {v3, p1}, Le/e0$a;->g(Ljava/lang/String;)Le/e0$a;

    invoke-virtual {v3}, Le/e0$a;->b()Le/e0$a;

    invoke-virtual {v3}, Le/e0$a;->a()Le/e0;
    ...
    invoke-virtual {v4, p1}, Le/b0;->s(Le/e0;)Le/j;

    move-result-object p1

    invoke-interface {p1}, Le/j;->r()Le/g0;

    move-result-object v3

    invoke-virtual {v3, v1}, Le/g0;->D(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Le/g0;->close()V
