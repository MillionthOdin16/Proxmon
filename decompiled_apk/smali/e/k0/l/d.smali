...
.method constructor <init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Le/k0/l/d;->c:Ljava/lang/reflect/Method;

    iput-object p2, p0, Le/k0/l/d;->d:Ljava/lang/reflect/Method;

    iput-object p3, p0, Le/k0/l/d;->e:Ljava/lang/reflect/Method;

    iput-object p4, p0, Le/k0/l/d;->f:Ljava/lang/Class;

    iput-object p5, p0, Le/k0/l/d;->g:Ljava/lang/Class;

    return-void
.end method

.method public static r()Le/k0/l/f;
    .locals 12
    ...
    new-instance v2, Le/k0/l/d;

    move-object v6, v2

    move-object v7, v1

    invoke-direct/range {v6 .. v11}, Le/k0/l/d;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    :try_end_1
...
.method public a(Ljavax/net/ssl/SSLSocket;)V
    ...
    :try_start_0
    iget-object v0, p0, Le/k0/l/d;->e:Ljava/lang/reflect/Method;
...
.method public g(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {p3}, Le/k0/l/f;->b(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    :try_start_0
    const-class p3, Le/k0/l/f;
    ...
    iget-object v2, p0, Le/k0/l/d;->f:Ljava/lang/Class;

    const/4 v3, 0x0

    aput-object v2, v1, v3

    iget-object v2, p0, Le/k0/l/d;->g:Ljava/lang/Class;

    const/4 v4, 0x1

    aput-object v2, v1, v4

    new-instance v2, Le/k0/l/d$a;

    invoke-direct {v2, p2}, Le/k0/l/d$a;-><init>(Ljava/util/List;)V
    ...
    iget-object p3, p0, Le/k0/l/d;->c:Ljava/lang/reflect/Method;
...
.method public l(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Le/k0/l/d;->d:Ljava/lang/reflect/Method;
    ...
    check-cast v0, Le/k0/l/d$a;

    iget-boolean v1, v0, Le/k0/l/d$a;->b:Z

    if-nez v1, :cond_0

    iget-object v1, v0, Le/k0/l/d$a;->c:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, p1}, Le/k0/l/f;->p(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_1
    iget-object p1, v0, Le/k0/l/d$a;->c:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
