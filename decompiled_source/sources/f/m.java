...
public final class m extends AbstractList<f> implements RandomAccess {
    ...
    private static void a(long j, c cVar, int i, List<f> list, int i2, int i3, List<Integer> list2) {
        ...
        int i10 = i7;
        if (fVar.h(i) == fVar2.h(i)) {
            int i11 = 0;
            int min = Math.min(fVar.o(), fVar2.o());
            for (int i12 = i; i12 < min && fVar.h(i12) == fVar2.h(i12); i12++) {
                i11++;
            }
            ...
            while (true) {
                ...
                cVar.X(fVar.h(i13) & 255);
                i13++;
            }
            if (i10 + 1 == i3) {
                if (i4 != list.get(i10).o()) {
                    throw new AssertionError();
                }
                cVar.X(list2.get(i10).intValue());
                return;
            } else {
                c cVar3 = new c();
                cVar.X((int) ((c(cVar3) + c2) * (-1)));
                a(c2, cVar3, i4, list, i10, i3, list2);
                cVar.e(cVar3, cVar3.N());
                return;
            }
        }
        int i14 = 1;
        for (int i15 = i10 + 1; i15 < i3; i15++) {
            if (list.get(i15 - 1).h(i) != list.get(i15).h(i)) {
                i14++;
            }
        }
        ...
        for (int i16 = i10; i16 < i3; i16++) {
            byte h = list.get(i16).h(i);
            if (i16 == i10 || h != list.get(i16 - 1).h(i)) {
                cVar.X(h & 255);
            }
        }
        c cVar4 = new c();
        ...
        while (i17 < i3) {
            ...
            if (i18 == i5 && i + 1 == list.get(i17).o()) {
                cVar.X(list2.get(i17).intValue());
                i6 = i5;
                cVar2 = cVar4;
            } else {
                cVar.X((int) ((c(cVar4) + c3) * (-1)));
                i6 = i5;
                cVar2 = cVar4;
