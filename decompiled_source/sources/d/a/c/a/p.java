...
public class p implements g<Object> {
    ...
    public static final p f1884a = new p();

    /* renamed from: b, reason: collision with root package name */
    private static final boolean f1885b;

    /* renamed from: c, reason: collision with root package name */
    private static final Charset f1886c;
    ...
    static {
        f1885b = ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN;
        f1886c = Charset.forName("UTF8");
    }
    ...
    protected Object g(byte b2, ByteBuffer byteBuffer) {
        ...
        switch (b2) {
            ...
            case 5:
                return new BigInteger(new String(d(byteBuffer), f1886c), 16);
            case 6:
                c(byteBuffer, 8);
                return Double.valueOf(byteBuffer.getDouble());
            case 7:
                return new String(d(byteBuffer), f1886c);
            case 8:
                return d(byteBuffer);
            case 9:
                e2 = e(byteBuffer);
    ...
    public void p(ByteArrayOutputStream byteArrayOutputStream, Object obj) {
        ...
        if (obj instanceof Number) {
            ...
            if ((obj instanceof Float) || (obj instanceof Double)) {
                ...
                i(byteArrayOutputStream, ((BigInteger) obj).toString(16).getBytes(f1886c));
                return;
            }
        }
        if (obj instanceof CharSequence) {
            byteArrayOutputStream.write(7);
            i(byteArrayOutputStream, obj.toString().getBytes(f1886c));
            return;
        }
