...
public class d {
    ...
    public static class a implements TypeEvaluator<c.b[]> {
        ...
        public c.b[] evaluate(float f2, c.b[] bVarArr, c.b[] bVarArr2) {
            if (!b.e.e.c.b(bVarArr, bVarArr2)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!b.e.e.c.b(this.f1312a, bVarArr)) {
                this.f1312a = b.e.e.c.f(bVarArr);
            }
            for (int i = 0; i < bVarArr.length; i++) {
                this.f1312a[i].d(bVarArr[i], bVarArr2[i], f2);
            }
            return this.f1312a;
        }
    }
    ...
    */
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: b.k.a.a.d.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        c.b[] d2 = b.e.e.c.d(string);
        c.b[] d3 = b.e.e.c.d(string2);
        if (d2 == null && d3 == null) {
            return null;
        }
        if (d2 == null) {
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k = b.e.d.d.g.k(resources, theme, attributeSet, b.k.a.a.a.j);
        int i = 0;
        TypedValue l = b.e.d.d.g.l(k, xmlPullParser, "value", 0);
        if ((l != null) && h(l.type)) {
            i = 3;
        }
        k.recycle();
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        TypedArray k = b.e.d.d.g.k(resources, theme, attributeSet, b.k.a.a.a.g);
        TypedArray k2 = b.e.d.d.g.k(resources, theme, attributeSet, b.k.a.a.a.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k, k2, f2, xmlPullParser);
        int h = b.e.d.d.g.h(k, xmlPullParser, "interpolator", 0, 0);
        if (h > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        TypedArray k = b.e.d.d.g.k(resources, theme, attributeSet, b.k.a.a.a.j);
        float f2 = b.e.d.d.g.f(k, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l = b.e.d.d.g.l(k, xmlPullParser, "value", 0);
        boolean z = l != null;
        if (i == 4) {
            i = (z && h(l.type)) ? 3 : 0;
        }
        Keyframe ofInt = z ? i != 0 ? (i == 1 || i == 3) ? Keyframe.ofInt(f2, b.e.d.d.g.g(k, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(f2, b.e.d.d.g.f(k, xmlPullParser, "value", 0, 0.0f)) : i == 0 ? Keyframe.ofFloat(f2) : Keyframe.ofInt(f2);
        int h = b.e.d.d.g.h(k, xmlPullParser, "interpolator", 1, 0);
        if (h > 0) {
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray k = b.e.d.d.g.k(resources, theme, attributeSet, b.k.a.a.a.i);
                String i2 = b.e.d.d.g.i(k, xmlPullParser, "propertyName", 3);
                int g = b.e.d.d.g.g(k, xmlPullParser, "valueType", 2, 4);
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long g = b.e.d.d.g.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g2 = b.e.d.d.g.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g3 = b.e.d.d.g.g(typedArray, xmlPullParser, "valueType", 7, 4);
        if (b.e.d.d.g.j(xmlPullParser, "valueFrom") && b.e.d.d.g.j(xmlPullParser, "valueTo")) {
            if (g3 == 4) {
                g3 = f(typedArray, 5, 6);
            }
            PropertyValuesHolder e2 = e(typedArray, g3, 5, 6, BuildConfig.VERSION_NAME);
            if (e2 != null) {
        ...
        valueAnimator.setRepeatCount(b.e.d.d.g.g(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(b.e.d.d.g.g(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
            r(valueAnimator, typedArray2, g3, f2, xmlPullParser);
        }
    }
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f2, XmlPullParser xmlPullParser) {
        ...
        String i2 = b.e.d.d.g.i(typedArray, xmlPullParser, "pathData", 1);
        if (i2 == null) {
            objectAnimator.setPropertyName(b.e.d.d.g.i(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String i3 = b.e.d.d.g.i(typedArray, xmlPullParser, "propertyXName", 2);
        String i4 = b.e.d.d.g.i(typedArray, xmlPullParser, "propertyYName", 3);
        if (i != 2) {
        }
        if (i3 != null || i4 != null) {
            s(b.e.e.c.e(i2), objectAnimator, f2 * 0.5f, i3, i4);
            return;
        }
