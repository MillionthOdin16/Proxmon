...
public class c extends ViewGroup implements l, b.e.j.k, b.e.j.i, m {
    ...
    private final b.e.j.j mNestedScrollingChildHelper;
    ...
    /* loaded from: classes.dex */
    public class C0043c extends Animation {
        C0043c() {
        }
    ...
    public class d extends Animation {
        ...
        @Override // android.view.animation.Animation
        public void applyTransformation(float f2, Transformation transformation) {
            c.this.mProgress.setAlpha((int) (this.f1287b + ((this.f1288c - r0) * f2)));
        }
    }
    ...
    class f extends Animation {
        ...
        public void applyTransformation(float f2, Transformation transformation) {
            ...
            c cVar2 = c.this;
            c.this.setTargetOffsetTopAndBottom((cVar2.mFrom + ((int) ((abs - r1) * f2))) - cVar2.mCircleView.getTop());
    ...
    public static class k extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeByte(this.f1294b ? (byte) 1 : (byte) 0);
        }
    }
    ...
    public c(Context context, AttributeSet attributeSet) {
        ...
        this.mNestedScrollingChildHelper = new b.e.j.j(this);
    ...
    private void createProgressView() {
        this.mCircleView = new b.j.b.a(getContext());
        b.j.b.b bVar = new b.j.b.b(getContext());
        this.mProgress = bVar;
        bVar.l(1);
    ...
    @Override // android.view.View, b.e.j.i
    ...
    public void requestDisallowInterceptTouchEvent(boolean z) {
        View view;
        ViewParent parent;
        if ((Build.VERSION.SDK_INT >= 21 || !(this.mTarget instanceof AbsListView)) && ((view = this.mTarget) == null || r.x(view))) {
    ...
    public void setColorSchemeResources(int... iArr) {
        ...
        for (int i2 = 0; i2 < iArr.length; i2++) {
            iArr2[i2] = b.e.d.a.b(context, iArr[i2]);
        }
    ...
    public void setProgressBackgroundColorSchemeResource(int i2) {
        setProgressBackgroundColorSchemeColor(b.e.d.a.b(getContext(), i2));
    }
    ...
    void startScaleDownAnimation(Animation.AnimationListener animationListener) {
        ...
        this.mScaleDownAnimation = c0043c;
        c0043c.setDuration(150L);
        this.mCircleView.b(animationListener);
        this.mCircleView.clearAnimation();
