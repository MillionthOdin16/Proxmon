...
public class i extends j {
    ...
    public Typeface b(Context context, c.b bVar, Resources resources, int i) {
        ...
        while (true) {
            ...
            c.C0028c c0028c = a2[i2];
            try {
                Font.Builder weight = new Font.Builder(resources, c0028c.b()).setWeight(c0028c.e());
                if (!c0028c.f()) {
                    i3 = 0;
                }
                Font build = weight.setSlant(i3).setTtcIndex(c0028c.c()).setFontVariationSettings(c0028c.d()).build();
                if (builder == null) {
