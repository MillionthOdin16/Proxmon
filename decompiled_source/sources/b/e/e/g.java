...
public class g extends e {
    ...
    public Typeface b(Context context, c.b bVar, Resources resources, int i) {
        ...
        for (c.C0028c c0028c : bVar.a()) {
            if (!q(context, o, c0028c.a(), c0028c.c(), c0028c.e(), c0028c.f() ? 1 : 0, FontVariationAxis.fromFontVariationSettings(c0028c.d()))) {
                p(o);
                return null;
            }
        }
    ...
    public Typeface c(Context context, CancellationSignal cancellationSignal, b.f[] fVarArr, int i) {
        ...
        Map<Uri, ByteBuffer> i2 = b.e.g.b.i(context, fVarArr, cancellationSignal);
        Object o = o();
        if (o == null) {
            return null;
        }
