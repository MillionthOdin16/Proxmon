...
public class j {
    ...
    private ConcurrentHashMap<Long, c.b> f1110a = new ConcurrentHashMap<>();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public class b implements c<c.C0028c> {
        b(j jVar) {
        }

        @Override // b.e.e.j.c
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public int a(c.C0028c c0028c) {
            return c0028c.e();
        }

        @Override // b.e.e.j.c
        /* renamed from: d, reason: merged with bridge method [inline-methods] */
        public boolean b(c.C0028c c0028c) {
            return c0028c.f();
        }
    }
    ...
    private void a(Typeface typeface, c.b bVar) {
        long j = j(typeface);
        if (j != 0) {
            this.f1110a.put(Long.valueOf(j), bVar);
        }
    }

    private c.C0028c f(c.b bVar, int i) {
        return (c.C0028c) g(bVar.a(), i, new b(this));
    }
    ...
    public c.b i(Typeface typeface) {
        ...
        return this.f1110a.get(Long.valueOf(j));
    }
}
