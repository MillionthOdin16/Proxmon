...
public final class h {
    public static MenuItem a(MenuItem menuItem, b bVar) {
        if (menuItem instanceof b.e.f.a.b) {
            return ((b.e.f.a.b) menuItem).a(bVar);
        }
    ...
    public static void b(MenuItem menuItem, char c2, int i) {
        if (menuItem instanceof b.e.f.a.b) {
            ((b.e.f.a.b) menuItem).setAlphabeticShortcut(c2, i);
    ...
    public static void f(MenuItem menuItem, char c2, int i) {
        if (menuItem instanceof b.e.f.a.b) {
            ((b.e.f.a.b) menuItem).setNumericShortcut(c2, i);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void g(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof b.e.f.a.b) {
            ((b.e.f.a.b) menuItem).setTooltipText(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
