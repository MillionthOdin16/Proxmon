...
public class NestedScrollView extends FrameLayout implements b.e.j.l, b.e.j.i {
    ...
    private final Rect f659c;

    /* renamed from: d, reason: collision with root package name */
    private OverScroller f660d;

    /* renamed from: e, reason: collision with root package name */
    private EdgeEffect f661e;

    /* renamed from: f, reason: collision with root package name */
    private EdgeEffect f662f;
    private int g;
    private boolean h;
    private boolean i;
    private View j;
    ...
    private c w;
    private final n x;
    private final b.e.j.j y;
    private float z;

    /* loaded from: classes.dex */
    static class a extends b.e.j.a {
        a() {
        }
        ...
        public void f(View view, AccessibilityEvent accessibilityEvent) {
            ...
            b.e.j.a0.d.a(accessibilityEvent, nestedScrollView.getScrollX());
            b.e.j.a0.d.b(accessibilityEvent, nestedScrollView.getScrollRange());
        }
    ...
    public static class c extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f663b + "}";
        }
    ...
    private void D(View view) {
        view.getDrawingRect(this.f659c);
        offsetDescendantRectToMyCoords(view, this.f659c);
        int e2 = e(this.f659c);
        if (e2 != 0) {
            scrollBy(0, e2);
        }
    ...
    private void G(int i, int i2, int i3, boolean z) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.f658b > 250) {
            View childAt = getChildAt(0);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
            int height = childAt.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin;
            int height2 = (getHeight() - getPaddingTop()) - getPaddingBottom();
            int scrollY = getScrollY();
            this.f660d.startScroll(getScrollX(), scrollY, 0, Math.max(0, Math.min(i2 + scrollY, Math.max(0, height - height2))) - scrollY, i3);
            B(z);
        } else {
            if (!this.f660d.isFinished()) {
                a();
            }
            scrollBy(i, i2);
        }
        this.f658b = AnimationUtils.currentAnimationTimeMillis();
    }

    private void a() {
        this.f660d.abortAnimation();
        K(1);
    }
    ...
    private void i() {
        ...
        A();
        K(0);
        EdgeEffect edgeEffect = this.f661e;
        if (edgeEffect != null) {
            edgeEffect.onRelease();
            this.f662f.onRelease();
        }
    }
    ...
    private void j() {
        if (getOverScrollMode() == 2) {
            ...
            Context context = getContext();
            this.f661e = new EdgeEffect(context);
            this.f662f = new EdgeEffect(context);
        }
    }

    private View l(boolean z, int i, int i2) {
    ...
    private void r() {
        this.f660d = new OverScroller(getContext());
        setFocusable(true);
    ...
    private boolean v(View view, int i, int i2) {
        view.getDrawingRect(this.f659c);
        offsetDescendantRectToMyCoords(view, this.f659c);
        return this.f659c.bottom + i >= getScrollY() && this.f659c.top - i <= getScrollY() + i2;
    }
    ...
    public boolean b(int i) {
        ...
        if (findNextFocus == null || !v(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f659c);
            offsetDescendantRectToMyCoords(findNextFocus, this.f659c);
            h(e(this.f659c));
    ...
    public void computeScroll() {
        ...
        this.f660d.computeScrollOffset();
        int currY = this.f660d.getCurrY();
        int i = currY - this.v;
        this.v = currY;
        int[] iArr = this.t;
        boolean z = false;
        ...
        if (i2 != 0) {
            int scrollY = getScrollY();
            y(0, i2, getScrollX(), scrollY, 0, scrollRange, 0, 0, false);
            int scrollY2 = getScrollY() - scrollY;
            int i3 = i2 - scrollY2;
            int[] iArr2 = this.t;
            iArr2[1] = 0;
        ...
        if (i2 != 0) {
            ...
            if (z) {
                j();
                if (i2 < 0) {
                    if (this.f661e.isFinished()) {
                        edgeEffect = this.f661e;
                        edgeEffect.onAbsorb((int) this.f660d.getCurrVelocity());
                    }
                } else if (this.f662f.isFinished()) {
                    edgeEffect = this.f662f;
                    edgeEffect.onAbsorb((int) this.f660d.getCurrVelocity());
                }
            }
            a();
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f661e != null) {
            ...
            if (!this.f661e.isFinished()) {
                ...
                this.f661e.setSize(width, height);
                if (this.f661e.draw(canvas)) {
                    r.D(this);
                }
                canvas.restoreToCount(save);
            }
            if (this.f662f.isFinished()) {
                return;
            }
            ...
            this.f662f.setSize(width2, height2);
            if (this.f662f.draw(canvas)) {
                r.D(this);
            }
    ...
    public void m(int i) {
        if (getChildCount() > 0) {
            this.f660d.fling(getScrollX(), getScrollY(), 0, i, 0, 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            B(true);
        }
    }
    ...
    public boolean n(int i) {
        ...
        if (z && (childCount = getChildCount()) > 0) {
            ...
            this.f659c.bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
            Rect rect2 = this.f659c;
            rect2.top = rect2.bottom - height;
        }
        Rect rect3 = this.f659c;
        return C(i, rect3.top, rect3.bottom);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (i != 0) {
            ...
            this.r = -1;
            A();
            if (this.f660d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                r.D(this);
            }
            K(0);
        } else {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.i) {
            if (this.w != null) {
                scrollTo(getScrollX(), this.w.f663b);
                this.w = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        findFocus.getDrawingRect(this.f659c);
        offsetDescendantRectToMyCoords(findFocus, this.f659c);
        h(e(this.f659c));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0076, code lost:
        ...
        if (r23.f660d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L25;
     */
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    boolean y(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        /*
            r12 = this;
            r0 = r12
        ...
        L5f:
            ...
            boolean r7 = r12.o(r5)
            if (r7 != 0) goto L7e
            android.widget.OverScroller r7 = r0.f660d
            r8 = 0
            r9 = 0
            r10 = 0
        ...
        L86:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.NestedScrollView.y(int, int, int, int, int, int, int, int, boolean):boolean");
    }
    ...
    public boolean z(int i) {
        ...
        int height = getHeight();
        if (z) {
            this.f659c.top = getScrollY() + height;
            int childCount = getChildCount();
            if (childCount > 0) {
                View childAt = getChildAt(childCount - 1);
