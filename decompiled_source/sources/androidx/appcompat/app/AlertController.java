...
public class AlertController {
    ...
    final androidx.appcompat.app.h f87b;

    /* renamed from: c, reason: collision with root package name */
    private final Window f88c;

    /* renamed from: d, reason: collision with root package name */
    private final int f89d;

    /* renamed from: e, reason: collision with root package name */
    private CharSequence f90e;

    /* renamed from: f, reason: collision with root package name */
    private CharSequence f91f;
    ListView g;
    private View h;
    private int i;
    private int j;
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.f93c = obtainStyledAttributes.getDimensionPixelOffset(b.a.j.RecycleListView_paddingBottomNoButtons, -1);
            this.f92b = obtainStyledAttributes.getDimensionPixelOffset(b.a.j.RecycleListView_paddingTopNoTitle, -1);
        }
        ...
        public void a(boolean z, boolean z2) {
            ...
            setPadding(getPaddingLeft(), z ? getPaddingTop() : this.f92b, getPaddingRight(), z2 ? getPaddingBottom() : this.f93c);
        }
    }
        ...
        */
        public void onClick(android.view.View r3) {
            ...
            L2f:
                ...
                r1 = 1
                androidx.appcompat.app.h r3 = r3.f87b
    ...
    public class b implements NestedScrollView.b {
        ...
        public void a(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4) {
            AlertController.f(nestedScrollView, this.f95a, this.f96b);
        }
    }
    ...
    public class c implements Runnable {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ View f97b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ View f98c;
        ...
        public void run() {
            AlertController.f(AlertController.this.A, this.f97b, this.f98c);
        }
    }
    ...
    public class d implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView absListView, int i, int i2, int i3) {
            AlertController.f(absListView, this.f100a, this.f101b);
        }
    ...
    public class e implements Runnable {
        ...
        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ View f102b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ View f103c;
        ...
        @Override // java.lang.Runnable
        public void run() {
            AlertController.f(AlertController.this.g, this.f102b, this.f103c);
        }
    }
    ...
    public static class f {
        ...
        public class a extends ArrayAdapter<CharSequence> {
            ...
            public View getView(int i, View view, ViewGroup viewGroup) {
                ...
                if (zArr != null && zArr[i]) {
                    this.f111b.setItemChecked(i, true);
                }
                return view2;
            }
        }
        ...
        public class b extends CursorAdapter {
            ...
            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ RecycleListView f115d;

            /* renamed from: e, reason: collision with root package name */
            final /* synthetic */ AlertController f116e;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            b(Context context, Cursor cursor, boolean z, RecycleListView recycleListView, AlertController alertController) {
                super(context, cursor, z);
                this.f115d = recycleListView;
                this.f116e = alertController;
                Cursor cursor2 = getCursor();
                this.f113b = cursor2.getColumnIndexOrThrow(f.this.L);
                this.f114c = cursor2.getColumnIndexOrThrow(f.this.M);
            }

            @Override // android.widget.CursorAdapter
            public void bindView(View view, Context context, Cursor cursor) {
                ((CheckedTextView) view.findViewById(R.id.text1)).setText(cursor.getString(this.f113b));
                this.f115d.setItemChecked(cursor.getPosition(), cursor.getInt(this.f114c) == 1);
            }

            @Override // android.widget.CursorAdapter
            public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
                return f.this.f106b.inflate(this.f116e.M, viewGroup, false);
            }
        }
        ...
        public class c implements AdapterView.OnItemClickListener {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ AlertController f118b;

            c(AlertController alertController) {
                this.f118b = alertController;
            }

            @Override // android.widget.AdapterView.OnItemClickListener
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                f.this.x.onClick(this.f118b.f87b, i);
                if (f.this.H) {
                    return;
                }
                this.f118b.f87b.dismiss();
            }
        }
        ...
        public class d implements AdapterView.OnItemClickListener {
            ...
            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ RecycleListView f120b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ AlertController f121c;

            d(RecycleListView recycleListView, AlertController alertController) {
                this.f120b = recycleListView;
                this.f121c = alertController;
            }
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                boolean[] zArr = f.this.F;
                if (zArr != null) {
                    zArr[i] = this.f120b.isItemChecked(i);
                }
                f.this.J.onClick(this.f121c.f87b, i, this.f120b.isItemChecked(i));
            }
        }
    ...
    private static final class g extends Handler {
        ...
        /* renamed from: a, reason: collision with root package name */
        private WeakReference<DialogInterface> f123a;

        public g(DialogInterface dialogInterface) {
            this.f123a = new WeakReference<>(dialogInterface);
        }
        ...
        public void handleMessage(Message message) {
            int i = message.what;
            if (i == -3 || i == -2 || i == -1) {
                ((DialogInterface.OnClickListener) message.obj).onClick(this.f123a.get(), message.what);
            } else {
                if (i != 1) {
                    return;
                }
    ...
    public AlertController(Context context, androidx.appcompat.app.h hVar, Window window) {
        ...
        this.J = obtainStyledAttributes.getResourceId(b.a.j.AlertDialog_android_layout, 0);
        this.K = obtainStyledAttributes.getResourceId(b.a.j.AlertDialog_buttonPanelSideLayout, 0);
        this.L = obtainStyledAttributes.getResourceId(b.a.j.AlertDialog_listLayout, 0);
        this.M = obtainStyledAttributes.getResourceId(b.a.j.AlertDialog_multiChoiceItemLayout, 0);
        this.N = obtainStyledAttributes.getResourceId(b.a.j.AlertDialog_singleChoiceItemLayout, 0);
        this.O = obtainStyledAttributes.getResourceId(b.a.j.AlertDialog_listItemLayout, 0);
        this.P = obtainStyledAttributes.getBoolean(b.a.j.AlertDialog_showTitle, true);
        this.f89d = obtainStyledAttributes.getDimensionPixelSize(b.a.j.AlertDialog_buttonIconDimen, 0);
    ...
    private void p(ViewGroup viewGroup, View view, int i, int i2) {
        View findViewById = this.f88c.findViewById(b.a.f.scrollIndicatorUp);
        View findViewById2 = this.f88c.findViewById(b.a.f.scrollIndicatorDown);
    ...
    private void v(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.f88c.findViewById(b.a.f.scrollView);
        ...
        CharSequence charSequence = this.f91f;
        if (charSequence != null) {
    ...
    private void w(ViewGroup viewGroup) {
        View view = this.h;
        if (view == null) {
            view = this.i != 0 ? LayoutInflater.from(this.f86a).inflate(this.i, viewGroup, false) : null;
        }
        boolean z = view != null;
        if (!z || !a(view)) {
            this.f88c.setFlags(131072, 131072);
        }
        if (!z) {
            viewGroup.setVisibility(8);
            return;
        }
        FrameLayout frameLayout = (FrameLayout) this.f88c.findViewById(b.a.f.custom);
        frameLayout.addView(view, new ViewGroup.LayoutParams(-1, -1));
        if (this.n) {
            frameLayout.setPadding(this.j, this.k, this.l, this.m);
        }
        if (this.g != null) {
            ((i0.a) viewGroup.getLayoutParams()).f453a = 0.0f;
        }
    }
    ...
    private void x(ViewGroup viewGroup) {
        if (this.G != null) {
            ...
            this.f88c.findViewById(b.a.f.title_template).setVisibility(8);
            return;
        }
        this.D = (ImageView) this.f88c.findViewById(R.id.icon);
        if (!(!TextUtils.isEmpty(this.f90e)) || !this.P) {
            this.f88c.findViewById(b.a.f.title_template).setVisibility(8);
            this.D.setVisibility(8);
            viewGroup.setVisibility(8);
            return;
        }
        TextView textView = (TextView) this.f88c.findViewById(b.a.f.alertTitle);
        this.E = textView;
        textView.setText(this.f90e);
        int i = this.B;
        if (i != 0) {
    ...
    private void y() {
        ...
        View findViewById2;
        View findViewById3 = this.f88c.findViewById(b.a.f.parentPanel);
        ...
        if (!z3 && i2 != null && (findViewById2 = i2.findViewById(b.a.f.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View findViewById10 = (this.f91f == null && this.g == null) ? null : i.findViewById(b.a.f.titleDividerNoCustom);
            if (findViewById10 != null) {
                findViewById10.setVisibility(0);
            }
        } else if (i2 != null && (findViewById = i2.findViewById(b.a.f.textSpacerNoTitle)) != null) {
    ...
    public int c(int i) {
        TypedValue typedValue = new TypedValue();
        this.f86a.getTheme().resolveAttribute(i, typedValue, true);
