...
public class i {
    ...
    private static final Class<?>[] f163b = {Context.class, AttributeSet.class};

    /* renamed from: c, reason: collision with root package name */
    private static final int[] f164c = {R.attr.onClick};

    /* renamed from: d, reason: collision with root package name */
    private static final String[] f165d = {"android.widget.", "android.view.", "android.webkit."};

    /* renamed from: e, reason: collision with root package name */
    private static final b.d.g<String, Constructor<? extends View>> f166e = new b.d.g<>();

    /* renamed from: a, reason: collision with root package name */
    private final Object[] f167a = new Object[2];
    ...
    public static class a implements View.OnClickListener {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final View f168b;

        /* renamed from: c, reason: collision with root package name */
        private final String f169c;

        /* renamed from: d, reason: collision with root package name */
        private Method f170d;
        ...
        private void a(Context context) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f169c, View.class)) != null) {
                        this.f170d = method;
                        this.f171e = context;
                        return;
                    }
            ...
            int id = this.f168b.getId();
            if (id == -1) {
                str = BuildConfig.VERSION_NAME;
            } else {
                str = " with id '" + this.f168b.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f169c + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f168b.getClass() + str);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            if (this.f170d == null) {
                a(this.f168b.getContext());
            }
            try {
                this.f170d.invoke(this.f171e, view);
    ...
    private void a(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (Build.VERSION.SDK_INT < 15 || r.t(view)) {
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f164c);
    ...
    private View r(Context context, String str, String str2) {
        String str3;
        Constructor<? extends View> constructor = f166e.get(str);
        if (constructor == null) {
            if (str2 != null) {
                try {
                    str3 = str2 + str;
            ...
            constructor = Class.forName(str3, false, context.getClassLoader()).asSubclass(View.class).getConstructor(f163b);
            f166e.put(str, constructor);
        }
        constructor.setAccessible(true);
        return constructor.newInstance(this.f167a);
    }
    ...
    private View s(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            this.f167a[0] = context;
            this.f167a[1] = attributeSet;
            if (-1 != str.indexOf(46)) {
                return r(context, str, null);
            }
            for (int i = 0; i < f165d.length; i++) {
                View r = r(context, str, f165d[i]);
                if (r != null) {
                    return r;
                }
            }
    ...
    private static Context t(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, b.a.j.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(b.a.j.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(b.a.j.View_theme, 0)) != 0) {
