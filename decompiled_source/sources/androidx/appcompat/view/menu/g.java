...
public class g implements b.e.f.a.a {
    ...
    private ArrayList<i> f270f = new ArrayList<>();
    ...
    public g(Context context) {
        this.f265a = context;
        this.f266b = context.getResources();
        b0(true);
    }
    ...
    private void b0(boolean z) {
        this.f268d = z && this.f266b.getConfiguration().keyboard != 1 && b.e.j.s.b(ViewConfiguration.get(this.f265a), this.f265a);
    }
    ...
    private boolean j(r rVar, m mVar) {
        ...
        boolean j = mVar != null ? mVar.j(rVar) : false;
        Iterator<WeakReference<m>> it = this.w.iterator();
        while (it.hasNext()) {
            WeakReference<m> next = it.next();
            m mVar2 = next.get();
    ...
    public ArrayList<i> E() {
        ...
        this.g.clear();
        int size = this.f270f.size();
        for (int i = 0; i < size; i++) {
            i iVar = this.f270f.get(i);
            if (iVar.isVisible()) {
                this.g.add(iVar);
            }
        }
    ...
    */
    ...
    protected MenuItem a(int i, int i2, int i3, CharSequence charSequence) {
        ...
        ArrayList<i> arrayList = this.f270f;
    ...
    public MenuItem add(int i) {
        return a(0, 0, 0, this.f266b.getString(i));
    }

    @Override // android.view.Menu
    public MenuItem add(int i, int i2, int i3, int i4) {
        return a(i, i2, i3, this.f266b.getString(i4));
    }
    ...
    public int addIntentOptions(int i, int i2, int i3, ComponentName componentName, Intent[] intentArr, Intent intent, int i4, MenuItem[] menuItemArr) {
        int i5;
        PackageManager packageManager = this.f265a.getPackageManager();
    ...
    public SubMenu addSubMenu(int i) {
        return addSubMenu(0, 0, 0, this.f266b.getString(i));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i2, int i3, int i4) {
        return addSubMenu(i, i2, i3, this.f266b.getString(i4));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        i iVar = (i) a(i, i2, i3, charSequence);
        r rVar = new r(this.f265a, this, iVar);
        iVar.x(rVar);
        return rVar;
    }
    ...
    public int m(int i, int i2) {
        ...
        while (i2 < size) {
            if (this.f270f.get(i2).getGroupId() == i) {
                return i2;
            }
            i2++;
        }
    ...
    public int o(int i) {
        int size = size();
        for (int i2 = 0; i2 < size; i2++) {
            if (this.f270f.get(i2).getItemId() == i) {
                return i2;
            }
        }
        return -1;
    ...
    public void removeGroup(int i) {
        int l = l(i);
        if (l >= 0) {
            int size = this.f270f.size() - l;
            int i2 = 0;
            while (true) {
                int i3 = i2 + 1;
                if (i2 >= size || this.f270f.get(l).getGroupId() != i) {
                    break;
                }
                N(l, false);
                i2 = i3;
