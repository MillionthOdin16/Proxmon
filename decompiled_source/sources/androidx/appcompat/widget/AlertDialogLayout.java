    ...
    private boolean A(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == b.a.f.topPanel) {
                    view = childAt;
                } else if (id == b.a.f.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != b.a.f.contentPanel && id != b.a.f.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = b.e.j.r.o(r17)
            int r2 = b.e.j.d.a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L95
            r3 = 5
