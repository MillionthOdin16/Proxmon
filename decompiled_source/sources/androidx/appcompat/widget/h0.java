...
public abstract class h0 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = h0.this.f438e.getParent();
            if (parent != null) {
    ...
    public h0(View view) {
        ...
        this.f435b = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f436c = tapTimeout;
        this.f437d = (tapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
    }

    private void a() {
        Runnable runnable = this.g;
        if (runnable != null) {
            this.f438e.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f439f;
        if (runnable2 != null) {
            this.f438e.removeCallbacks(runnable2);
        }
    }
    ...
    private boolean f(MotionEvent motionEvent) {
        ...
        if (b2 == null || !b2.c() || (f0Var = (f0) b2.g()) == null || !f0Var.isShown()) {
            return false;
        }
    ...
    */
    private boolean g(android.view.MotionEvent r6) {
        ...
        L41:
            ...
            r5.i = r6
            java.lang.Runnable r6 = r5.f439f
            if (r6 != 0) goto L52
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z2) {
            ...
            if (z) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
                this.f438e.onTouchEvent(obtain);
                obtain.recycle();
            }
        }
        this.h = z;
