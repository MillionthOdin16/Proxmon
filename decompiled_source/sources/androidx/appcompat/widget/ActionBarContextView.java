...
public class ActionBarContextView extends androidx.appcompat.widget.a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        w0 u = w0.u(context, attributeSet, b.a.j.ActionMode, i, 0);
        b.e.j.r.K(this, u.f(b.a.j.ActionMode_background));
        this.q = u.m(b.a.j.ActionMode_titleTextStyle, 0);
        this.r = u.m(b.a.j.ActionMode_subtitleTextStyle, 0);
        this.f384f = u.l(b.a.j.ActionMode_height, 0);
        this.t = u.m(b.a.j.ActionMode_closeItemLayout, b.a.g.abc_action_mode_close_item_material);
        u.v();
    }
    ...
    private void i() {
        if (this.n == null) {
            ...
            this.n = linearLayout;
            this.o = (TextView) linearLayout.findViewById(b.a.f.action_bar_title);
    ...
    */
    public void h(b.a.n.b r4) {
        ...
        L22:
            ...
            androidx.appcompat.widget.c r0 = r3.f383e
            if (r0 == 0) goto L3f
            r0.y()
        L3f:
            ...
            r2 = -1
            r0.<init>(r1, r2)
            androidx.appcompat.widget.c r1 = r3.f383e
            android.content.Context r2 = r3.f381c
            r4.c(r1, r2)
            androidx.appcompat.widget.c r4 = r3.f383e
            androidx.appcompat.view.menu.n r4 = r4.o(r3)
            androidx.appcompat.widget.ActionMenuView r4 = (androidx.appcompat.widget.ActionMenuView) r4
            r3.f382d = r4
            r1 = 0
            b.e.j.r.K(r4, r1)
            androidx.appcompat.widget.ActionMenuView r4 = r3.f382d
            r3.addView(r4, r0)
            return
        */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        ActionMenuView actionMenuView = this.f382d;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (actionMenuView != null && actionMenuView.getParent() == this) {
            paddingLeft = c(this.f382d, paddingLeft, makeMeasureSpec, 0);
        }
        LinearLayout linearLayout = this.n;
