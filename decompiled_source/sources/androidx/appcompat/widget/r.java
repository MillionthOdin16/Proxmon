...
class r {
    ...
    private static final int[] f523c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    private final ProgressBar f524a;

    /* renamed from: b, reason: collision with root package name */
    private Bitmap f525b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public r(ProgressBar progressBar) {
        this.f524a = progressBar;
    }
    ...
    public void c(AttributeSet attributeSet, int i) {
        w0 u = w0.u(this.f524a.getContext(), attributeSet, f523c, i, 0);
        Drawable g = u.g(0);
        if (g != null) {
            this.f524a.setIndeterminateDrawable(e(g));
        }
        Drawable g2 = u.g(1);
        if (g2 != null) {
            this.f524a.setProgressDrawable(d(g2, false));
        }
        u.v();
    }
}
