...
public final class Recreator implements e {
    ...
    private void h(String str) {
        try {
            ...
            try {
                ...
                try {
                    ((SavedStateRegistry.a) declaredConstructor.newInstance(new Object[0])).a(this.f876a);
                } catch (Exception e2) {
    ...
    public void d(g gVar, d.a aVar) {
        ...
        Bundle a2 = this.f876a.getSavedStateRegistry().a("androidx.savedstate.Restarter");
        if (a2 == null) {
            return;
        }
