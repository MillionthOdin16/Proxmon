...
public class c extends AccessibilityNodeProvider {
    ...
    private final io.flutter.embedding.engine.j.b f2818b;

    /* renamed from: c, reason: collision with root package name */
    private final AccessibilityManager f2819c;

    /* renamed from: d, reason: collision with root package name */
    private final AccessibilityViewEmbedder f2820d;

    /* renamed from: e, reason: collision with root package name */
    private final io.flutter.plugin.platform.j f2821e;
    ...
    private k s;
    private boolean t;
    private final b.InterfaceC0073b u;
    ...
    public class a implements b.InterfaceC0073b {
        ...
        @Override // io.flutter.embedding.engine.j.b.InterfaceC0073b
        ...
        public void e(String str) {
            c.this.f2817a.announceForAccessibility(str);
        }
    ...
    class b implements AccessibilityManager.AccessibilityStateChangeListener {
        ...
        public void onAccessibilityStateChanged(boolean z) {
            ...
            io.flutter.embedding.engine.j.b bVar = c.this.f2818b;
            if (z) {
                bVar.g(c.this.u);
                c.this.f2818b.e();
            } else {
            ...
            if (c.this.s != null) {
                c.this.s.a(z, c.this.f2819c.isTouchExplorationEnabled());
            }
        }
    }
    ...
    /* loaded from: classes.dex */
    class C0083c extends ContentObserver {
        C0083c(Handler handler) {
            super(handler);
        }
        ...
        public void onChange(boolean z, Uri uri) {
            ...
            String string = Build.VERSION.SDK_INT < 17 ? null : Settings.Global.getString(c.this.f2822f, "transition_animation_scale");
            if (string != null && string.equals("0")) {
                cVar = c.this;
                i = cVar.l | f.DISABLE_ANIMATIONS.f2833b;
            } else {
                cVar = c.this;
                i = cVar.l & (f.DISABLE_ANIMATIONS.f2833b ^ (-1));
            }
            cVar.l = i;
            c.this.N();
        }
    ...
    class d implements AccessibilityManager.TouchExplorationStateChangeListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ AccessibilityManager f2826a;

        d(AccessibilityManager accessibilityManager) {
            this.f2826a = accessibilityManager;
        }
        ...
        public void onTouchExplorationStateChanged(boolean z) {
            ...
            c cVar = c.this;
            if (z) {
                i = cVar.l | f.ACCESSIBLE_NAVIGATION.f2833b;
            } else {
                cVar.F();
                cVar = c.this;
                i = cVar.l & (f.ACCESSIBLE_NAVIGATION.f2833b ^ (-1));
            }
            cVar.l = i;
            c.this.N();
            if (c.this.s != null) {
                c.this.s.a(this.f2826a.isEnabled(), z);
            }
        }
    }
    ...
    public static class l {
        ...
        private SpannableString a0(String str, List<n> list) {
            ...
            if (list != null) {
                for (n nVar : list) {
                    int i = e.f2828a[nVar.f2858c.ordinal()];
                    if (i == 1) {
                        spannableString.setSpan(new TtsSpan.Builder("android.type.verbatim").build(), nVar.f2856a, nVar.f2857b, 0);
                    } else if (i == 2) {
                        spannableString.setSpan(new LocaleSpan(Locale.forLanguageTag(((j) nVar).f2849d)), nVar.f2856a, nVar.f2857b, 0);
                    }
                }
            }
        ...
        private List<n> h0(ByteBuffer byteBuffer, ByteBuffer[] byteBufferArr) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (i5 == 1) {
                    ...
                    jVar.f2857b = i4;
                    jVar.f2858c = oVar;
                    jVar.f2849d = Charset.forName("UTF-8").decode(byteBuffer2).toString();
                    arrayList.add(jVar);
                }
            }
            return arrayList;
        ...
        public boolean j0(g gVar) {
            return (gVar.f2838b & this.B) != 0;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public boolean k0(i iVar) {
            return (iVar.f2848b & this.A) != 0;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public boolean l0(g gVar) {
            return (gVar.f2838b & this.f2853d) != 0;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public boolean m0(i iVar) {
            return (iVar.f2848b & this.f2852c) != 0;
        }
        ...
        public boolean o0() {
            ...
            return ((((((g.SCROLL_RIGHT.f2838b | g.SCROLL_LEFT.f2838b) | g.SCROLL_UP.f2838b) | g.SCROLL_DOWN.f2838b) ^ (-1)) & this.f2853d) == 0 && this.f2852c == 0 && ((str = this.o) == null || str.isEmpty()) && (((str2 = this.q) == null || str2.isEmpty()) && ((str3 = this.w) == null || str3.isEmpty()))) ? false : true;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static boolean r0(l lVar, d.a.d.c<l> cVar) {
        ...
        public void u0(ByteBuffer byteBuffer, String[] strArr, ByteBuffer[] byteBufferArr) {
            ...
            this.D = this.h;
            this.E = this.l;
            this.f2852c = byteBuffer.getInt();
            this.f2853d = byteBuffer.getInt();
            this.f2854e = byteBuffer.getInt();
            this.f2855f = byteBuffer.getInt();
            ...
            for (int i8 = 0; i8 < i7; i8++) {
                l v = this.f2850a.v(byteBuffer.getInt());
                v.M = this;
                this.N.add(v);
            }
            for (int i9 = 0; i9 < i7; i9++) {
                l v2 = this.f2850a.v(byteBuffer.getInt());
                v2.M = this;
                this.O.add(v2);
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                h u = this.f2850a.u(byteBuffer.getInt());
                if (u.f2841c == g.TAP.f2838b) {
                    this.Q = u;
                } else if (u.f2841c == g.LONG_PRESS.f2838b) {
                    this.R = u;
                } else {
                    this.P.add(u);
                }
    ...
    public c(View view, io.flutter.embedding.engine.j.b bVar, AccessibilityManager accessibilityManager, ContentResolver contentResolver, AccessibilityViewEmbedder accessibilityViewEmbedder, io.flutter.plugin.platform.j jVar) {
        ...
        this.u = new a();
        this.v = new b();
        this.x = new C0083c(new Handler());
        this.f2817a = view;
        this.f2818b = bVar;
        this.f2819c = accessibilityManager;
        this.f2822f = contentResolver;
        this.f2820d = accessibilityViewEmbedder;
        this.f2821e = jVar;
        this.v.onAccessibilityStateChanged(accessibilityManager.isEnabled());
        this.f2819c.addAccessibilityStateChangeListener(this.v);
        if (Build.VERSION.SDK_INT >= 19) {
            d dVar = new d(accessibilityManager);
            this.w = dVar;
            dVar.onTouchExplorationStateChanged(accessibilityManager.isTouchExplorationEnabled());
            this.f2819c.addTouchExplorationStateChangeListener(this.w);
        } else {
            this.w = null;
        }
        if (Build.VERSION.SDK_INT >= 17) {
            this.x.onChange(false);
            this.f2822f.registerContentObserver(Settings.Global.getUriFor("transition_animation_scale"), false, this.x);
        }
        if (jVar != null) {
            jVar.a(this);
        }
    ...
    public AccessibilityEvent C(int i2, int i3) {
        ...
        obtain.setPackageName(this.f2817a.getContext().getPackageName());
        obtain.setSource(this.f2817a, i2);
        return obtain;
    }
    ...
    private void G(l lVar) {
        ...
        AccessibilityEvent C = C(lVar.f2851b, 32);
        C.getText().add(g0);
        M(C);
    }
    ...
    private boolean H(l lVar, int i2, Bundle bundle, boolean z) {
        ...
        if (i3 != 1) {
            ...
            if (z && lVar.l0(g.MOVE_CURSOR_FORWARD_BY_WORD)) {
                bVar = this.f2818b;
                gVar = g.MOVE_CURSOR_FORWARD_BY_WORD;
            } else {
                if (z || !lVar.l0(g.MOVE_CURSOR_BACKWARD_BY_WORD)) {
                    return false;
                }
                bVar = this.f2818b;
                gVar = g.MOVE_CURSOR_BACKWARD_BY_WORD;
            }
        } else if (z && lVar.l0(g.MOVE_CURSOR_FORWARD_BY_CHARACTER)) {
            bVar = this.f2818b;
            gVar = g.MOVE_CURSOR_FORWARD_BY_CHARACTER;
        } else {
            if (z || !lVar.l0(g.MOVE_CURSOR_BACKWARD_BY_CHARACTER)) {
                return false;
            }
            bVar = this.f2818b;
            gVar = g.MOVE_CURSOR_BACKWARD_BY_CHARACTER;
        }
        bVar.c(i2, gVar, Boolean.valueOf(z2));
        return true;
    }

    @TargetApi(21)
    private boolean I(l lVar, int i2, Bundle bundle) {
        String string = (bundle == null || !bundle.containsKey("ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE")) ? BuildConfig.VERSION_NAME : bundle.getString("ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE");
        this.f2818b.c(i2, g.SET_TEXT, string);
        lVar.q = string;
        return true;
    }
    ...
    */
    ...
    public void M(AccessibilityEvent accessibilityEvent) {
        if (this.f2819c.isEnabled()) {
            this.f2817a.getParent().requestSendAccessibilityEvent(this.f2817a, accessibilityEvent);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void N() {
        this.f2818b.f(this.l);
    }
    ...
    private void P(String str) {
        this.f2817a.setAccessibilityPaneTitle(str);
    }

    private boolean R(final l lVar) {
        return lVar.j > 0 && (l.r0(this.i, new d.a.d.c() { // from class: io.flutter.view.a
            @Override // d.a.d.c
            public final boolean a(Object obj) {
                return c.A(c.l.this, (c.l) obj);
            }
        }) || !l.r0(this.i, new d.a.d.c() { // from class: io.flutter.view.b
            @Override // d.a.d.c
            public final boolean a(Object obj) {
                boolean m0;
    ...
    private void U(l lVar) {
        ...
        Integer num;
        lVar.M = null;
        if (lVar.i != -1 && (num = this.j) != null && this.f2820d.platformViewOfNode(num.intValue()) == this.f2821e.c(Integer.valueOf(lVar.i))) {
            L(this.j.intValue(), 65536);
            this.j = null;
        }
        if (lVar.i != -1 && !this.f2821e.d(Integer.valueOf(lVar.i)) && (c2 = this.f2821e.c(Integer.valueOf(lVar.i))) != null) {
            c2.setImportantForAccessibility(4);
        }
        l lVar2 = this.i;
        if (lVar2 == lVar) {
            L(lVar2.f2851b, 65536);
            this.i = null;
        }
        if (this.m == lVar) {
            this.m = null;
    ...
    @TargetApi(28)
    private boolean r() {
        Activity b2 = d.a.d.d.b(this.f2817a.getContext());
    ...
    public boolean E(MotionEvent motionEvent) {
        if (!this.f2819c.isTouchExplorationEnabled() || this.g.isEmpty()) {
            return false;
        }
        l n0 = w().n0(new float[]{motionEvent.getX(), motionEvent.getY(), 0.0f, 1.0f});
        if (n0 != null && n0.i != -1) {
            return this.f2820d.onAccessibilityHoverEvent(n0.f2851b, motionEvent);
        }
    ...
    public void K() {
        this.t = true;
        io.flutter.plugin.platform.j jVar = this.f2821e;
        if (jVar != null) {
            jVar.b();
        }
        Q(null);
        this.f2819c.removeAccessibilityStateChangeListener(this.v);
        if (Build.VERSION.SDK_INT >= 19) {
            this.f2819c.removeTouchExplorationStateChangeListener(this.w);
        }
        this.f2822f.unregisterContentObserver(this.x);
        this.f2818b.g(null);
    }
    ...
    void S(ByteBuffer byteBuffer, String[] strArr) {
        while (byteBuffer.hasRemaining()) {
            ...
            u.f2841c = byteBuffer.getInt();
            int i2 = byteBuffer.getInt();
            String str = null;
            u.f2842d = i2 == -1 ? null : strArr[i2];
            int i3 = byteBuffer.getInt();
            if (i3 != -1) {
                str = strArr[i3];
            }
    ...
    void T(ByteBuffer byteBuffer, String[] strArr, ByteBuffer[] byteBufferArr) {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            if (!v.m0(i.IS_HIDDEN)) {
                ...
                if (v.i != -1 && !this.f2821e.d(Integer.valueOf(v.i)) && (c2 = this.f2821e.c(Integer.valueOf(v.i))) != null) {
        ...
        if (w != null) {
            ...
            if (i2 >= 23) {
                if ((i2 >= 28 ? r() : true) && (rootWindowInsets = this.f2817a.getRootWindowInsets()) != null) {
        ...
        for (l lVar4 : arrayList2) {
            if (!this.p.contains(Integer.valueOf(lVar4.f2851b))) {
                lVar3 = lVar4;
            }
        }
        ...
        if (lVar3 != null && (lVar3.f2851b != this.q || arrayList2.size() != this.p.size())) {
            this.q = lVar3.f2851b;
            G(lVar3);
        }
        this.p.clear();
        ...
        while (it.hasNext()) {
            this.p.add(Integer.valueOf(((l) it.next()).f2851b));
        }
        Iterator<Map.Entry<Integer, l>> it2 = this.g.entrySet().iterator();
        while (it2.hasNext()) {
        ...
        while (it3.hasNext()) {
            l lVar5 = (l) it3.next();
            if (lVar5.c0()) {
                AccessibilityEvent C = C(lVar5.f2851b, 4096);
                float f4 = lVar5.l;
                float f5 = lVar5.m;
            ...
            l lVar6 = this.i;
            if (lVar6 != null && lVar6.f2851b == lVar5.f2851b && !lVar5.k0(i.IS_SELECTED) && lVar5.m0(i.IS_SELECTED)) {
                AccessibilityEvent C2 = C(lVar5.f2851b, 4);
                C2.getText().add(lVar5.o);
                M(C2);
            }
            l lVar7 = this.m;
            if (lVar7 != null && lVar7.f2851b == lVar5.f2851b && ((lVar2 = this.n) == null || lVar2.f2851b != this.m.f2851b)) {
                this.n = this.m;
                M(C(lVar5.f2851b, 8));
            } else if (this.m == null) {
                this.n = null;
            ...
            l lVar8 = this.m;
            if (lVar8 != null && lVar8.f2851b == lVar5.f2851b && lVar5.k0(i.IS_TEXT_FIELD) && lVar5.m0(i.IS_TEXT_FIELD) && ((lVar = this.i) == null || lVar.f2851b == this.m.f2851b)) {
                String str = lVar5.F;
                String str2 = BuildConfig.VERSION_NAME;
                String str3 = str != null ? lVar5.F : BuildConfig.VERSION_NAME;
                if (lVar5.q != null) {
                    str2 = lVar5.q;
                }
                AccessibilityEvent q = q(lVar5.f2851b, str3, str2);
                if (q != null) {
                    M(q);
                }
                if (lVar5.C != lVar5.g || lVar5.D != lVar5.h) {
                    AccessibilityEvent C3 = C(lVar5.f2851b, 8192);
                    C3.getText().add(str2);
    ...
    */
    ...
    public boolean performAction(int i2, int i3, Bundle bundle) {
        ...
        int i4;
        if (i2 >= 65536) {
            boolean performAction = this.f2820d.performAction(i2, i3, bundle);
        ...
        switch (i3) {
            case 16:
                this.f2818b.b(i2, g.TAP);
                return true;
            case 32:
                this.f2818b.b(i2, g.LONG_PRESS);
                return true;
            case 64:
                this.f2818b.b(i2, g.DID_GAIN_ACCESSIBILITY_FOCUS);
                L(i2, 32768);
                if (this.i == null) {
                ...
                return true;
            case 128:
                this.f2818b.b(i2, g.DID_LOSE_ACCESSIBILITY_FOCUS);
                L(i2, 65536);
                this.i = null;
                this.j = null;
                return true;
            ...
            case 4096:
                if (lVar.l0(g.SCROLL_UP)) {
                    bVar = this.f2818b;
                    gVar = g.SCROLL_UP;
                } else if (lVar.l0(g.SCROLL_LEFT)) {
                    bVar = this.f2818b;
                    gVar = g.SCROLL_LEFT;
                } else {
                    if (!lVar.l0(g.INCREASE)) {
                        return false;
                    }
                    lVar.q = lVar.s;
                    lVar.r = lVar.t;
                ...
                return true;
            case 8192:
                if (lVar.l0(g.SCROLL_DOWN)) {
                    bVar2 = this.f2818b;
                    gVar2 = g.SCROLL_DOWN;
                } else if (lVar.l0(g.SCROLL_RIGHT)) {
                    bVar2 = this.f2818b;
                    gVar2 = g.SCROLL_RIGHT;
                } else {
                    if (!lVar.l0(g.DECREASE)) {
                        return false;
                    }
                    lVar.q = lVar.u;
                    lVar.r = lVar.v;
                ...
                return true;
            case 16384:
                this.f2818b.b(i2, g.COPY);
                return true;
            case 32768:
                this.f2818b.b(i2, g.PASTE);
                return true;
            case 65536:
                this.f2818b.b(i2, g.CUT);
                return true;
            case 131072:
                if (Build.VERSION.SDK_INT < 18) {
                    return false;
                ...
                this.f2818b.c(i2, g.SET_SELECTION, hashMap);
            ...
            case R.id.accessibilityActionShowOnScreen:
                this.f2818b.b(i2, g.SHOW_ON_SCREEN);
                return true;
            default:
                ...
                this.f2818b.c(i2, g.CUSTOM_ACTION, Integer.valueOf(hVar.f2840b));
                return true;
        }
    }
    ...
    public boolean s(View view, View view2, AccessibilityEvent accessibilityEvent) {
        ...
        if (!this.f2820d.requestSendAccessibilityEvent(view, view2, accessibilityEvent) || (recordFlutterId = this.f2820d.getRecordFlutterId(view, accessibilityEvent)) == null) {
            return false;
        }
    ...
    public boolean y() {
        return this.f2819c.isEnabled();
    }

    public boolean z() {
        return this.f2819c.isTouchExplorationEnabled();
    }
}
