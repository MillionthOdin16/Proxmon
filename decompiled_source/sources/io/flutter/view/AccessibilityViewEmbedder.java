...
class AccessibilityViewEmbedder {
    ...
    public static class b {
        ...
        private final Method f2807a;

        /* renamed from: b, reason: collision with root package name */
        private final Method f2808b;

        /* renamed from: c, reason: collision with root package name */
        private final Method f2809c;

        /* renamed from: d, reason: collision with root package name */
        private final Method f2810d;

        /* renamed from: e, reason: collision with root package name */
        private final Field f2811e;

        /* renamed from: f, reason: collision with root package name */
        private final Method f2812f;
        ...
        public Long f(AccessibilityNodeInfo accessibilityNodeInfo, int i) {
            String str;
            if (this.f2810d == null && (this.f2811e == null || this.f2812f == null)) {
                return null;
            }
            Method method = this.f2810d;
            if (method != null) {
                try {
                ...
                try {
                    return Long.valueOf(((Long) this.f2812f.invoke(this.f2811e.get(accessibilityNodeInfo), Integer.valueOf(i))).longValue());
    ...
    public static class c {
        ...
        public boolean equals(Object obj) {
            ...
            c cVar = (c) obj;
            return this.f2814b == cVar.f2814b && this.f2813a.equals(cVar.f2813a);
        }

        public int hashCode() {
            return ((this.f2813a.hashCode() + 31) * 31) + this.f2814b;
        }
    }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (cVar == null || !this.embeddedViewToDisplayBounds.containsKey(cVar.f2813a) || cVar.f2813a.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = cVar.f2813a.getAccessibilityNodeProvider().createAccessibilityNodeInfo(cVar.f2814b)) == null) {
            return null;
        }
        return convertToFlutterNode(createAccessibilityNodeInfo, i, cVar.f2813a);
    }
    ...
    public boolean onAccessibilityHoverEvent(int i, MotionEvent motionEvent) {
        ...
        Rect rect = this.embeddedViewToDisplayBounds.get(cVar.f2813a);
        ...
        return cVar.f2813a.dispatchGenericMotionEvent(MotionEvent.obtain(motionEvent.getDownTime(), motionEvent.getEventTime(), motionEvent.getAction(), motionEvent.getPointerCount(), pointerPropertiesArr, pointerCoordsArr, motionEvent.getMetaState(), motionEvent.getButtonState(), motionEvent.getXPrecision(), motionEvent.getYPrecision(), motionEvent.getDeviceId(), motionEvent.getEdgeFlags(), motionEvent.getSource(), motionEvent.getFlags()));
    }

    public boolean performAction(int i, int i2, Bundle bundle) {
        AccessibilityNodeProvider accessibilityNodeProvider;
        c cVar = this.flutterIdToOrigin.get(i);
        if (cVar == null || (accessibilityNodeProvider = cVar.f2813a.getAccessibilityNodeProvider()) == null) {
            return false;
        }
        return accessibilityNodeProvider.performAction(cVar.f2814b, i2, bundle);
    }
