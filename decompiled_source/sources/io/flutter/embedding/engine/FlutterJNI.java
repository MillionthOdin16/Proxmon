...
public class FlutterJNI {
    ...
    private final Set<b.InterfaceC0067b> engineLifecycleListeners = new CopyOnWriteArraySet();
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, final long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                ...
                d.a.b.c(TAG, "Failed to decode image", e2);
            }
        }
        return null;
    }
    ...
    private native void nativeSetViewportMetrics(long j, float f2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15);
    ...
    private void onPreEngineRestart() {
        Iterator<b.InterfaceC0067b> it = this.engineLifecycleListeners.iterator();
        while (it.hasNext()) {
            it.next().a();
        }
    }
    ...
    public void addEngineLifecycleListener(b.InterfaceC0067b interfaceC0067b) {
        ensureRunningOnMainThread();
        this.engineLifecycleListeners.add(interfaceC0067b);
    }
    ...
    String[] computePlatformResolvedLocale(String[] strArr) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            strArr2[2] = BuildConfig.VERSION_NAME;
        }
        return strArr2;
    }
    ...
    public void dispatchSemanticsAction(int i, c.g gVar, Object obj) {
        ...
        ensureAttachedToNative();
        if (obj != null) {
            byteBuffer = p.f1884a.b(obj);
            i2 = byteBuffer.position();
        } else {
            byteBuffer = null;
            i2 = 0;
        }
        dispatchSemanticsAction(i, gVar.f2838b, byteBuffer, i2);
    }
    ...
    public void onDisplayPlatformView(int i, int i2, int i3, int i4, int i5, int i6, int i7, FlutterMutatorsStack flutterMutatorsStack) {
        ...
        kVar.S(i, i2, i3, i4, i5, i6, i7, flutterMutatorsStack);
    }
    ...
    public void removeEngineLifecycleListener(b.InterfaceC0067b interfaceC0067b) {
        ensureRunningOnMainThread();
        this.engineLifecycleListeners.remove(interfaceC0067b);
    }
    ...
    public void setViewportMetrics(float f2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15) {
        ensureRunningOnMainThread();
        ensureAttachedToNative();
        nativeSetViewportMetrics(this.nativeShellHolderId.longValue(), f2, i, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15);
    }
